...
@section('content_header')
    <h1>Editar Tipo de Facturación</h1>
@stop
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('tipo_facturacion.update', $tipo_facturacion->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="descripcion" type="text"
                                        ...
                                        value="{{ old('descripcion', $tipo_facturacion->descripcion) }}" required
